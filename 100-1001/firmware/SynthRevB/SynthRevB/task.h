...
extern PRIORITYQUEUE ActiveTasks;		//priority task queue
extern TCB *pCurrentTask,*pNextTask;
extern int OsRunning;
extern volatile int TStamp;
extern volatile int InterruptCount;

extern void CreateTask(TCB *t, void (*task)(void *), int stacksize,int priority,void *arg);
extern TCB *NewTask(void (*task)(void *),int stacksize,int priority,void *arg);
