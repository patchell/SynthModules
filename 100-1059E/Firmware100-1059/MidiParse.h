...
#define SYSEX_CMD_CHANNEL_CH1		(0x01)
#define SYSEX_CMD_CHANNEL_CH2		(0x02)
#define SYSEX_CMD_CHANNEL_TRIG		(0x03)
#define SYSEX_CMD_GETCHANNEL_CH1	(0x04)
#define SYSEX_CMD_GETCHANNEL_CH2	(0x05)
#define SYSEX_CMD_GETCHANNEL_TRIG	(0x06)
#define SYSEX_CMD_SEQ_LOAD			(0x07)
#define SYSEX_CMD_SEQ_SAVE			(0x08)
//------------------------------
// SYSEX format
//-----------------------------
